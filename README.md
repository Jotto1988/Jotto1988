...
- **[Aurora Repair](https://aurora-repair.com/)** — AI-driven vehicle damage
  ...
  [Source](https://github.com/Jotto1988/AI-Autobody-Assessor-Tool)
...
- **[Sure Drive](https://sure-drive-9a8c9.web.app/)** — Digital loyalty
  currency system built to route around insurance/credit regulation while
  still delivering real customer value.
  [Source](https://github.com/Jotto1988/Autobody-Business-Tool)

## Open Source

- **[Task Bridge](https://github.com/Jotto1988/task-bridge)** — An open
...
- **Approved, Anthropic Cyber Verification Program** — vetted and approved to
  conduct dual-use security research (red teaming, penetration testing, bug
  bounty work) using Claude.
- Hands-on web application security research via [TryHackMe](https://tryhackme.com/p/forgevertical),
  covering IDOR, SQL injection, XSS, SSRF, command injection, auth bypass,
  file inclusion, content discovery, and subdomain enumeration.
- Active bug bounty researcher via HackerOne, with real, live findings on
  production systems.
